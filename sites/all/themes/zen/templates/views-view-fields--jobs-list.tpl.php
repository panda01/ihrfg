 ...
 */
?>
<p class="jobs_date_posted"><?php print $fields[created]->content; ?></p>
<h2><?php print $fields[field_job_title_value]->content; ?></h2>
<p><?php print $fields[field_organization_value]->content; ?></p>
<?php print $fields[teaser]->content; ?>
<p class="read_more"><?php print $fields[view_node]->content; ?></p>
